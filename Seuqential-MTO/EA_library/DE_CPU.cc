...
int DE_CPU::Initilize(IslandInfo island_info, ProblemInfo problem_info)
{
    EA_CPU::Initilize(island_info, problem_info);
...
int DE_CPU::InitilizePopulation(Population & population, int task_ID)
{
    EA_CPU::InitilizePopulation(population, task_ID);
...
int DE_CPU::Reproduce(Population & population, int task_ID)
{
...
int DE_CPU::Run(Population & population, int task_ID)
{
    Reproduce(population, task_ID);
